...
_UPD: Since solana devnet transactions become unavailable after some time, here's code that can be used to emit test transactions_
...
-   _flattening_ transactions with CPI calls
